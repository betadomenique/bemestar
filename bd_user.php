...
$idade=$_POST['idade'];
$localidade_user=$_POST['localidade_user'];
$especialidade_user=$_POST['especialidade_user'];
...
$consulta=$ligacao->prepare("insert into utilizadores (nome_user, idade, localidade_user, especialidade_user, email_user) values('$nome_user', $idade, '$localidade_user', '$especialidade_user', '$email_user') "); 
$consulta->execute();
...
?>
<div>
<a class="btn btn-success" style="margin-top: 15px" href='index.html'>Voltar</a>
</div>
